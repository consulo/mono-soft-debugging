 ...
 * {@link StackFrameMirror}), and even debugger-specific constructs (for example,
 ...
 * <p>
 * Any method on a {@link mono.debugger.Mirror} that takes a <code>Mirror</code> as an
 * parameter directly or indirectly (e.g., as a element in a <code>List</code>) will
 * throw {@link mono.debugger.VMMismatchException} if the mirrors are from different
 * virtual machines.
 *
 * @see VirtualMachine
 *
