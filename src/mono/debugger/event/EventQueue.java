 ...
 * {@link mono.debugger.VirtualMachine VirtualMachine}.
 * <P>
 * Some events cause the suspension of the target VM - event requests
 * ({@link mono.debugger.request}) with a
 * {@link mono.debugger.request.EventRequest#suspendPolicy() suspend policy}
 * of {@link mono.debugger.request.EventRequest#SUSPEND_ALL SUSPEND_ALL}
 * or {@link mono.debugger.request.EventRequest#SUSPEND_EVENT_THREAD
...
public interface EventQueue extends Mirror {
     ...
     * this thread.
     * @throws mono.debugger.VMDisconnectedException if the connection
     * to the target VM is no longer available.  Note this will always
     * be preceded by a {@link mono.debugger.event.VMDisconnectEvent}.
     */
