...
import mono.debugger.connect.spi.TransportService;        // for javadoc

/**
 * A method of communication between a debugger and a target VM.
 *
 * <p> A Transport represents the transport mechanism used by a
 * {@link mono.debugger.connect.Connector Connector} to establish a
 ...
 * encapsulates a {@link mono.debugger.connect.spi.TransportService
