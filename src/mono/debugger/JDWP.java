		...
		static class Set
		{
			...
			static class Modifier
			{
				...
				static class FieldOnly extends ModifierCommon
				{
					...
					static Modifier create(TypeMirror declaring, long fieldID)
					{
					...
					FieldOnly(TypeMirror declaring, long fieldID)
					{
				...
				static class InstanceOnly extends ModifierCommon
				{
					...
					static Modifier create(MirrorWithId instance)
					{
					 ...
					 */
					final MirrorWithId instance;

					InstanceOnly(MirrorWithId instance)
					{
	...
	static class StackFrame
	{
		...
		static class ThisObject
		{
			...
			private ThisObject(VirtualMachineImpl vm, PacketStream ps)
			{
				...
				objectThis = ps.readObjectMirror();
				if(vm.traceReceives)
				{
					vm.printReceiveTrace(4, "objectThis(ObjectReferenceImpl): " + (objectThis == null ? "NULL" : "ref=" + objectThis.id()));
				}
			}
		}
