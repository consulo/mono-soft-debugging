...
public class JDWP
{
	...
	static class VirtualMachine
	{
		...
		static class TopLevelThreadGroups
		{
			...
			static PacketStream enqueueCommand(VirtualMachineImpl vm)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.TopLevelThreadGroups" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				ps.send();
				return ps;
			...
			private TopLevelThreadGroups(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.TopLevelThreadGroups" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
				if(vm.traceReceives)
				{
		...
		static class CreateString
		{
			...
			static CreateString process(
					VirtualMachineImpl vm, String utf) throws JDWPException
			{
			...
			static PacketStream enqueueCommand(
					VirtualMachineImpl vm, String utf)
			{
				PacketStream ps = new PacketStream(vm, COMMAND_SET, COMMAND);
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.CreateString" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private CreateString(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.CreateString" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
		...
		static class Capabilities
		{
			...
			static PacketStream enqueueCommand(VirtualMachineImpl vm)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.Capabilities" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				ps.send();
				return ps;
			...
			private Capabilities(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.Capabilities" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
		...
		static class ClassPaths
		{
			...
			static PacketStream enqueueCommand(VirtualMachineImpl vm)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.ClassPaths" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				ps.send();
				return ps;
			...
			private ClassPaths(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.ClassPaths" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
		...
		static class DisposeObjects
		{
			...
			static class Request
			{
				...
				private void write(PacketStream ps)
				{
					if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
					{
						ps.vm.printTrace("Sending:                     object(ObjectReferenceImpl): " + (object == null ? "NULL" : "ref=" + object
								.ref()));
					}
			...
			static DisposeObjects process(
					VirtualMachineImpl vm, Request[] requests) throws JDWPException
			{
			...
			static PacketStream enqueueCommand(
					VirtualMachineImpl vm, Request[] requests)
			{
				PacketStream ps = new PacketStream(vm, COMMAND_SET, COMMAND);
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.DisposeObjects" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private DisposeObjects(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.DisposeObjects" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
			}
		}
		...
		static class HoldEvents
		{
			...
			static PacketStream enqueueCommand(VirtualMachineImpl vm)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.HoldEvents" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				ps.send();
				return ps;
			...
			private HoldEvents(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.HoldEvents" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
			}
		}
		...
		static class ReleaseEvents
		{
			...
			static PacketStream enqueueCommand(VirtualMachineImpl vm)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.ReleaseEvents" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				ps.send();
				return ps;
			...
			private ReleaseEvents(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.ReleaseEvents" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
			}
		}
		...
		static class CapabilitiesNew
		{
			...
			static PacketStream enqueueCommand(VirtualMachineImpl vm)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.CapabilitiesNew" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				ps.send();
				return ps;
			...
			private CapabilitiesNew(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.CapabilitiesNew" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
				canWatchFieldModification = ps.readBoolean();
				if(vm.traceReceives)
		...
		static class RedefineClasses
		{
			...
			static class ClassDef
			{
				...
				private void write(PacketStream ps)
				{
					if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
					{
						ps.vm.printTrace("Sending:                     refType(ReferenceTypeImpl): " + (refType == null ? "NULL" : "ref=" + refType
								.ref()));
					}
			...
			static RedefineClasses process(
					VirtualMachineImpl vm, ClassDef[] classes) throws JDWPException
			{
			...
			static PacketStream enqueueCommand(
					VirtualMachineImpl vm, ClassDef[] classes)
			{
				PacketStream ps = new PacketStream(vm, COMMAND_SET, COMMAND);
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.RedefineClasses" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private RedefineClasses(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.RedefineClasses" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
			}
		}
		...
		static class SetDefaultStratum
		{
			...
			static SetDefaultStratum process(
					VirtualMachineImpl vm, String stratumID) throws JDWPException
			{
			...
			static PacketStream enqueueCommand(
					VirtualMachineImpl vm, String stratumID)
			{
				PacketStream ps = new PacketStream(vm, COMMAND_SET, COMMAND);
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.SetDefaultStratum" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private SetDefaultStratum(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.SetDefaultStratum" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
			}
		}
		...
		static class InstanceCounts
		{
			...
			static InstanceCounts process(
					VirtualMachineImpl vm, ReferenceTypeImpl[] refTypesCount) throws JDWPException
			{
			...
			static PacketStream enqueueCommand(
					VirtualMachineImpl vm, ReferenceTypeImpl[] refTypesCount)
			{
				PacketStream ps = new PacketStream(vm, COMMAND_SET, COMMAND);
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.InstanceCounts" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
				...
				for(int i = 0; i < refTypesCount.length; i++)
				{
					if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
					{
						ps.vm.printTrace("Sending:                     refTypesCount[i](ReferenceTypeImpl): " + (refTypesCount[i] == null ? "NULL" :
								"ref=" + refTypesCount[i].ref()));
					}
			...
			private InstanceCounts(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.VirtualMachine.InstanceCounts" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
				if(vm.traceReceives)
				{
	...
	static class ObjectReference
	{
		...
		static class MonitorInfo
		{
					...
					VirtualMachineImpl vm, ObjectReferenceImpl object)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ObjectReference.MonitorInfo" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private MonitorInfo(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ObjectReference.MonitorInfo" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
	...
	static class ThreadReference
	{
		...
		static class Name
		{
					...
					VirtualMachineImpl vm, ThreadReferenceImpl thread)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.Name" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private Name(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.Name" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
		...
		static class Status
		{
					...
					VirtualMachineImpl vm, ThreadReferenceImpl thread)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.Status" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
		...
		static class ThreadGroup
		{
					...
					VirtualMachineImpl vm, ThreadReferenceImpl thread)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.ThreadGroup" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private ThreadGroup(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.ThreadGroup" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
		...
		static class OwnedMonitors
		{
					...
					VirtualMachineImpl vm, ThreadReferenceImpl thread)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.OwnedMonitors" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private OwnedMonitors(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.OwnedMonitors" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
				if(vm.traceReceives)
				{
		...
		static class CurrentContendedMonitor
		{
			...
			static CurrentContendedMonitor process(
					VirtualMachineImpl vm, ThreadReferenceImpl thread) throws JDWPException
			{
				PacketStream ps = enqueueCommand(vm, thread);
				return waitForReply(vm, ps);
					...
					VirtualMachineImpl vm, ThreadReferenceImpl thread)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.CurrentContendedMonitor" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private CurrentContendedMonitor(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.CurrentContendedMonitor" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
		...
		static class Stop
		{
			...
			static Stop process(
					VirtualMachineImpl vm, ThreadReferenceImpl thread, ObjectReferenceImpl throwable) throws JDWPException
			{
			...
			static PacketStream enqueueCommand(
					VirtualMachineImpl vm, ThreadReferenceImpl thread, ObjectReferenceImpl throwable)
			{
				PacketStream ps = new PacketStream(vm, COMMAND_SET, COMMAND);
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.Stop" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
				...
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
					ps.vm.printTrace("Sending:                 throwable(ObjectReferenceImpl): " + (throwable == null ? "NULL" : "ref=" + throwable
							.ref()));
				}
			...
			private Stop(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.Stop" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
			}
		}
		...
		static class Interrupt
		{
					...
					VirtualMachineImpl vm, ThreadReferenceImpl thread)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.Interrupt" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private Interrupt(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.Interrupt" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
			}
		}
		...
		static class OwnedMonitorsStackDepthInfo
		{
			...
			static OwnedMonitorsStackDepthInfo process(
					VirtualMachineImpl vm, ThreadReferenceImpl thread) throws JDWPException
			{
				PacketStream ps = enqueueCommand(vm, thread);
				return waitForReply(vm, ps);
					...
					VirtualMachineImpl vm, ThreadReferenceImpl thread)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.OwnedMonitorsStackDepthInfo" + (ps.pkt.flags != 0 ? "," +
							" FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private OwnedMonitorsStackDepthInfo(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.OwnedMonitorsStackDepthInfo" + (ps.pkt.flags != 0 ?
							", FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
				if(vm.traceReceives)
				{
		...
		static class ForceEarlyReturn
		{
			...
			static ForceEarlyReturn process(
					VirtualMachineImpl vm, ThreadReferenceImpl thread, ValueImpl value) throws JDWPException
			{
			...
			static PacketStream enqueueCommand(
					VirtualMachineImpl vm, ThreadReferenceImpl thread, ValueImpl value)
			{
				PacketStream ps = new PacketStream(vm, COMMAND_SET, COMMAND);
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.ForceEarlyReturn" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private ForceEarlyReturn(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadReference.ForceEarlyReturn" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
			}
		}
	...
	static class ThreadGroupReference
	{
		...
		static class Name
		{
			...
			static Name process(
					VirtualMachineImpl vm, ThreadGroupReferenceImpl group) throws JDWPException
			{
			...
			static PacketStream enqueueCommand(
					VirtualMachineImpl vm, ThreadGroupReferenceImpl group)
			{
				PacketStream ps = new PacketStream(vm, COMMAND_SET, COMMAND);
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadGroupReference.Name" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private Name(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadGroupReference.Name" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
		...
		static class Parent
		{
					...
					VirtualMachineImpl vm, ThreadGroupReferenceImpl group)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadGroupReference.Parent" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private Parent(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadGroupReference.Parent" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
		...
		static class Children
		{
					...
					VirtualMachineImpl vm, ThreadGroupReferenceImpl group)
			{
				...
				if((vm.traceFlags & mono.debugger.VirtualMachine.TRACE_SENDS) != 0)
				{
					vm.printTrace("Sending Command(id=" + ps.pkt.id + ") JDWP.ThreadGroupReference.Children" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : ""));
				}
				if((ps.vm.traceFlags & VirtualMachineImpl.TRACE_SENDS) != 0)
				{
			...
			private Children(VirtualMachineImpl vm, PacketStream ps)
			{
				if(vm.traceReceives)
				{
					vm.printTrace("Receiving Command(id=" + ps.pkt.id + ") JDWP.ThreadGroupReference.Children" + (ps.pkt.flags != 0 ? ", " +
							"FLAGS=" + ps.pkt.flags : "") + (ps.pkt.errorCode != 0 ? ", ERROR CODE=" + ps.pkt.errorCode : ""));
				}
				if(vm.traceReceives)
				{
				...
				for(int i = 0; i < childThreadsCount; i++)
				{
					...
					if(vm.traceReceives)
					{
						vm.printReceiveTrace(5, "childThreads[i](ThreadReferenceImpl): " + (childThreads[i] == null ? "NULL" : "ref=" +
								childThreads[i].ref()));
					}
				}
				if(vm.traceReceives)
				...
				for(int i = 0; i < childGroupsCount; i++)
				{
					...
					if(vm.traceReceives)
					{
						vm.printReceiveTrace(5, "childGroups[i](ThreadGroupReferenceImpl): " + (childGroups[i] == null ? "NULL" : "ref=" +
								childGroups[i].ref()));
					}
				}
			}
