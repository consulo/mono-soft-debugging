 ...
 * {@link mono.debugger.connect.Connector#defaultArguments()}) to the end user,
 * allowing the user to
 * fill in the transport-specific address generated by the target VM.
 * <LI>
 * Debugger calls the {@link mono.debugger.connect.AttachingConnector#attach(java.util.Map)} method
 ...
 * transports.</LI>
 * <LI>
 * Debugger calls the {@link mono.debugger.connect.ListeningConnector#startListening(java.util.Map)} method for each selected
 ...
 * <LI>
 * Debugger calls
 * {@link mono.debugger.connect.ListeningConnector#accept(java.util.Map)}
 ...
 * {@link mono.debugger.connect.ListeningConnector#accept(java.util.Map)} for that
 * transport.</LI>
 * <LI>
 * Debugger's call to {@link mono.debugger.connect.ListeningConnector#accept(java.util.Map)} returns
 ...
 * {@link mono.debugger.connect.Connector#defaultArguments()}) to specify
 ...
 * <LI>
 * Debugger calls the
 * {@link mono.debugger.connect.AttachingConnector#attach(java.util.Map)} method
 * of the selected to attach to the target VM. A {@link VirtualMachine}
 * mirror is returned.
 * </TD>
 * </TR>
 ...
 * <tt>mono.debugger.connect.Connector</tt> in the resource directory
 ...
 * {@link mono.debugger.connect.Connector Connector} interface. More
 * appropriately the class implements one of the specific Connector
 * types, namely {@link mono.debugger.connect.AttachingConnector
 * AttachingConnector}, {@link mono.debugger.connect.ListeningConnector
 * ListeningConnector}, or {@link mono.debugger.connect.LaunchingConnector
 ...
 * {@link mono.debugger.connect.spi.TransportService} type, and that jar
 * file contains a provider configuration file named
 * <tt>mono.debugger.connect.spi.TransportService</tt> in the resource
 ...
 * sub-class of {@link mono.debugger.connect.spi.TransportService
 ...
 * {@link mono.debugger.connect.ListeningConnector}. These
 * Connectors are created to encapsulate a {@link
 * mono.debugger.connect.Transport Transport} that in turn
 ...
 * mono.debugger.connect.spi.TransportService#name() name()} method
 ...
 * mono.debugger.connect.Connector#description() description()} method
 * of both the AttachingConnector, and the ListeningConnector, will
 * delegate to the {@link mono.debugger.connect.spi.TransportService#description()
 ...
 * Connector {@link mono.debugger.connect.Connector$Argument Arguments}.
 * A {@link mono.debugger.connect.Connector$StringArgument StringArgument}
 * named <tt>address</tt> is the connector argument to specify the
 * address to attach too, or to listen on. A
 * {@link mono.debugger.connect.Connector$IntegerArgument IntegerArgument}
