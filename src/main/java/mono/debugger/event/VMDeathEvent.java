 ...
 * {@link mono.debugger.VirtualMachine#dispose()
 *      VirtualMachine.dispose()}
 * <P>
 * On VM termination, a single unsolicited VMDeathEvent
 * will always be sent with a
 * {@link mono.debugger.request.EventRequest#suspendPolicy() suspend policy}
 * of {@link mono.debugger.request.EventRequest#SUSPEND_NONE SUSPEND_NONE}.
 * Additional VMDeathEvents will be sent in the same event set if they are
 * requested with a
 * {@link mono.debugger.request.VMDeathRequest VMDeathRequest}.
 * <P>
 ...
 * @see mono.debugger.request.VMDeathRequest
 * @see EventQueue
 * @see VirtualMachine
 *
 * @author Robert Field
