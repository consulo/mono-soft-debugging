...
public class SocketListeningConnector extends GenericListeningConnector
{
	...
	public static final String ARG_LOCALADDR = "localAddress";

	public SocketListeningConnector()
	{
		super(new SocketTransportService());

		addIntegerArgument(ARG_PORT, "", false, 0, Integer.MAX_VALUE);

		addStringArgument(ARG_LOCALADDR, "",                                         // default is wildcard
				false);
